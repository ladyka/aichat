...
- Пиши **литературным русским** — и в документации, и в ответах пользователю. Никакого сленга и никаких переносных кличек вместо имён вещей: «контора», «полка», «вьюха», «фича», «жильцы» в текстах этого репозитория не встречаются. Вещь называем своим именем: организация, версия, экран, функция.
