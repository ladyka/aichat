...
aichat — чат в браузере и, заодно, ключ к тому же разговору по API. Модели берутся у OpenRouter (только бесплатные с витрины) и, если настроен, у e7 на Ollama. В разговоре можно спросить погоду, заказать пиццу с pzz.by, войти почтой или через Google и Apple. Это лицо сервиса для людей; как устроены версии и аудитории — в таблицах ниже.
