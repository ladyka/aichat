...
| [Дорожная карта](product/roadmap.md) | Карта и состояния: выпущенная первая версия, планы второй, бэклог |
| [Версия 1 (выпущена)](product/v1/index.md) | Восемь функций витрины по отдельности: чат, модели, вход, API, руки, навыки, шаринг, телефон |
